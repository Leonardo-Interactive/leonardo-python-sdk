...
class Prompt(BaseSDK):
    def prompt_improve(
        ...
        *,
        request: Union[
            operations.PromptImproveRequestBody,
            operations.PromptImproveRequestBodyTypedDict,
        ],
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", operations.PromptImproveRequestBody
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.PromptImproveResponse(
                object=utils.unmarshal_json(
                    http_res.text, Optional[operations.PromptImproveResponseBody]
                ),
    ...
    async def prompt_improve_async(
        self,
        *,
        request: Union[
            operations.PromptImproveRequestBody,
    ...
    def prompt_random(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.PromptRandomResponse(
                object=utils.unmarshal_json(
                    http_res.text, Optional[operations.PromptRandomResponseBody]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
