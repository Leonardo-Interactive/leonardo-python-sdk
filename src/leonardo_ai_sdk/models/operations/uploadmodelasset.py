...
class UploadModelAssetRequestBody(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["modelExtension", "name"])
...
class ModelAssetUploadOutput(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["modelFields", "modelId", "modelKey", "modelUrl"])
        nullable_fields = set(["modelFields", "modelId", "modelKey", "modelUrl"])
        serialized = handler(self)
        m = {}
...
class UploadModelAssetResponseBody(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["uploadModelAsset"])
        nullable_fields = set(["uploadModelAsset"])
        serialized = handler(self)
        m = {}
...
try:
    UploadModelAssetRequestBody.model_rebuild()
except NameError:
    pass
try:
    ModelAssetUploadOutput.model_rebuild()
except NameError:
    pass
try:
    UploadModelAssetResponseBody.model_rebuild()
except NameError:
    pass
