...
class GetGenerationByIDResponseBody(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["generations_by_pk"])
        nullable_fields = set(["generations_by_pk"])
        serialized = handler(self)
        m = {}
...
try:
    GetGenerationByIDGeneratedImageVariationGeneric.model_rebuild()
except NameError:
    pass
try:
    GeneratedImages.model_rebuild()
except NameError:
    pass
try:
    GetGenerationByIDLoras.model_rebuild()
except NameError:
    pass
try:
    GenerationElements.model_rebuild()
except NameError:
    pass
try:
    GetGenerationByIDGenerations.model_rebuild()
except NameError:
    pass
