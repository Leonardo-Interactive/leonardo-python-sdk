...
class GetDatasetByIDDatasets(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["createdAt", "dataset_images", "description", "id", "name", "updatedAt"]
        )
        nullable_fields = set(["description", "id"])
        serialized = handler(self)
        m = {}
...
class GetDatasetByIDResponseBody(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["datasets_by_pk"])
        nullable_fields = set(["datasets_by_pk"])
        serialized = handler(self)
        m = {}
...
try:
    DatasetImages.model_rebuild()
except NameError:
    pass
try:
    GetDatasetByIDDatasets.model_rebuild()
except NameError:
    pass
