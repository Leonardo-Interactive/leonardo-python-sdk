...
class PricingCalculator(BaseSDK):
    def pricing_calculator(
        self,
        *,
        request: Optional[
            Union[
                operations.PricingCalculatorRequestBody,
                operations.PricingCalculatorRequestBodyTypedDict,
            ]
        ] = None,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[operations.PricingCalculatorRequestBody],
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.PricingCalculatorResponse(
                object=utils.unmarshal_json(
                    http_res.text, Optional[operations.PricingCalculatorResponseBody]
                ),
    ...
    async def pricing_calculator_async(
        self,
        *,
        request: Optional[
            Union[
