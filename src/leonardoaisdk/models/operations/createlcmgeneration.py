...
class CreateLCMGenerationRequestBody:
    ...
    guidance: Optional[float] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('guidance'), 'exclude': lambda f: f is CreateLCMGenerationRequestBody.UNSET }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CreateLCMGenerationResponseBody:
    r"""Responses for POST /generations-lcm"""
    UNSET='__SPEAKEASY_UNSET__'
    lcm_generation_job: Optional[LcmGenerationOutput] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lcmGenerationJob'), 'exclude': lambda f: f is CreateLCMGenerationResponseBody.UNSET }})
    



@dataclasses.dataclass
class CreateLCMGenerationResponse:
    ...
    object: Optional[CreateLCMGenerationResponseBody] = dataclasses.field(default=None)
    r"""Responses for POST /generations-lcm"""
