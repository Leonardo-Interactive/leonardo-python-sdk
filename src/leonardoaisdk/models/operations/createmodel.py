...
class CreateModelRequestBody:
    ...
    model_type: Optional[shared_custom_model_type.CustomModelType] = dataclasses.field(default=shared.CustomModelType.GENERAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modelType'), 'exclude': lambda f: f is None }})
    ...
    strength: Optional[shared_strength.Strength] = dataclasses.field(default=shared.Strength.MEDIUM, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('strength'), 'exclude': lambda f: f is None }})
